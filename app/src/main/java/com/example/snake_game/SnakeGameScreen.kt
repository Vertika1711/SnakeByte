...
import com.example.snake_game.ui.theme.Citrine
import com.example.snake_game.ui.theme.Custard
import com.example.snake_game.ui.theme.RoyalBlue
...
fun SnakeGameScreen(
    ...
    val foodImageBitmap = ImageBitmap.imageResource(id = R.drawable.apple)
...
private fun DrawScope.drawGameBoard(
    ...
    for (i in 0 until gridWidth){ //Columns
        for (j in 0 until gridHeight){ //Rows
